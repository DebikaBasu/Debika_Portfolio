...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_rn5yt28', 'template_r6936ke', form.current, 'avmTtdxOP07X5W35adxoQ')
      .then((response) => {
            ...
            <Card style={style}>
              <CardContent>
                ...
                <Typography
                  ...
                  style={{ cursor: "pointer" }}
                  onClick={() =>
                    window.open("https://www.instagram.com/devika.basu/")
                  }
                  color="primary"
                  mt={1.5}
                >
            ...
            <Card style={style}>
              <CardContent>
                ...
                <Typography
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.linkedin.com/in/debikabasu/"
                    )
                  }
                  color="primary"
                  mt={1.5}
